...
console.log('Outside: ' + mix("Are they here", "yes, they are here"));
console.log('Outside: ' + mix("looping is fun but dangerous", "less dangerous than coding"));